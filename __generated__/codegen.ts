...
export type GetTweetDataQuery = { getTweetData: { __typename?: 'Tweet', name: string, username: string, profileImageUrl: string, createdAt: string, text: string, source: string } | null | undefined };
